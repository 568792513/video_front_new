 ...
 * All rights reserved.
 */
package com.hui.vedio_service.vedio.common.config.mybatis.utils;
...
public class DateTimeUtils {
    ...
    /**
     * com.ch999.installment.common.util.DateTimeUtils.localDate()
     *
     * @return
     */
    ...
    public static void main(String[] paramArrayOfString) {
        ...
        // try {
        // System.out.println(formatDate(addMonths(parseDate("2013-01-06"),
        // 12)));
